    ...
    : WaylandNativeWindowBuffer(), bo(nullptr), dmabuf_fd(-1), wl_dmabuf(dmabuf)
{
    ...
    uint32_t req_format = (_format == HAL_PIXEL_FORMAT_RGBX_8888) ? GBM_FORMAT_XBGR8888 : GBM_FORMAT_ABGR8888;
...
void DrmWaylandBuffer::init(struct android_wlegl *android_wlegl, struct wl_display *display, struct wl_event_queue *queue) {
    ...
    uint32_t req_format = (this->format == HAL_PIXEL_FORMAT_RGBX_8888) ? GBM_FORMAT_XBGR8888 : GBM_FORMAT_ABGR8888;
